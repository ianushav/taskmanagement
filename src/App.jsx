...
import TaskImage from "../src/assets/taskimage.png"
import "./App.css";
...
export default function App() {
  ...
  return (
    <div className={`min-h-screen min-w-screen flex flex-col lg:flex-row overflow-hidden ${theme === "dark" ? "bg-gray-900 text-white" : "bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 text-white"}`}>
      ...
      >
        <img src={`${import.meta.env.BASE_URL}taskimage.png`} alt="Task Management" className="w-100 h-100 object-cover mb-5 rounded-lg shadow-lg" />
